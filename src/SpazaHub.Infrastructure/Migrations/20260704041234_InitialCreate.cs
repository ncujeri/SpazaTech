        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashOutAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    FeeRateApplied = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    FeeRoundingApplied = table.Column<int>(type: "int", nullable: false),
                    ...
                    FlaggedForOwnerReview = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanDoCashback = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CashbackTransactionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeclaredCash = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    CashierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CashierSignedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OwnerSignedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReminderConsent = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceRefreshTokens", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeeIncomes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CachedQuantity = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashRoundingAdjustment = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CashRoundingIncrement = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CashbackFeeRate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CashbackFeeRounding = table.Column<int>(type: "int", nullable: false),
                    TradingDayRollHour = table.Column<int>(type: "int", nullable: false),
                    MaxCashbackPerTransaction = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    MaxCashbackPerDay = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CashbackOwnerReviewThreshold = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DrawerCashFloor = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CashiersMayOverrideCreditLimit = table.Column<bool>(type: "bit", nullable: false),
                    MaxRemindersPerDebtorPerWeek = table.Column<int>(type: "int", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    TargetReference = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitCostSnapshot = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashbackTransactions_TenantId",
                table: "CashbackTransactions",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_Cashiers_TenantId",
                table: "Cashiers",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashMovements_TenantId_OccurredAtUtc",
                table: "CashMovements",
                columns: new[] { "TenantId", "OccurredAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_CashUps_TenantId",
                table: "CashUps",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditEntries_TenantId_CustomerId_OccurredAtUtc",
                table: "CreditEntries",
                columns: new[] { "TenantId", "CustomerId", "OccurredAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomerMessages_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceRefreshTokens_TokenHash",
                table: "DeviceRefreshTokens",
                column: "TokenHash",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_TenantId_OccurredAtUtc",
                table: "Sales",
                columns: new[] { "TenantId", "OccurredAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_TenantId_ProductId_OccurredAtUtc",
                table: "StockMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VasTransactions_TenantId",
                table: "VasTransactions",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_VasTransactions_TenantId_IdempotencyKey",
                table: "VasTransactions",
                columns: new[] { "TenantId", "IdempotencyKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WalletMovements_TenantId",
